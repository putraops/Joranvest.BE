...
func (service *webinarSpeakerService) GetSpeakerReviewById(recordId string) helper.Response {
	return service.webinarSpeakerRepository.GetSpeakerReviewById(recordId)
}
