...
type EducationPlaylistUser struct {
	...
	EducationPlaylistId string       `gorm:"type:varchar(50);not null" json:"education_playlist_id"`
	ApplicationUserId   string       `gorm:"type:varchar(50);not null" json:"application_user_id"`

	EducationPlaylist EducationPlaylist `gorm:"foreignkey:EducationPlaylistId;constraint:onUpdate:CASCADE,onDelete:CASCADE" json:"education_playlist"`
...
func (EducationPlaylistUser) TableName() string {
	return "education_playlist_user"
}
