...
type apiTestRequesterMock struct {
	mock.Mock
}

func (m *apiTestRequesterMock) Call(ctx context.Context, method string, path string, secretKey string, header *http.Header, params interface{}, result interface{}) *xendit.Error {
...
func TestCreatePayment(t *testing.T) {
	apiRequesterMockObj := new(apiTestRequesterMock)
