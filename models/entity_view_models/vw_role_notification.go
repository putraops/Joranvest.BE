...
type EntityRoleNotificationView struct {
...
func (EntityRoleNotificationView) TableName() string {
	return "vw_role_notification"
}

func (EntityRoleNotificationView) ViewModel() string {
	...
	sql.WriteString("  ro.description AS role_description,")
	sql.WriteString("  r.has_payment_notification,")
	sql.WriteString("  r.payment_notification_type,")
	...
	sql.WriteString("FROM role_notification r ")
...
func (EntityRoleNotificationView) Migration() map[string]string {
	var view = EntityRoleNotificationView{}
