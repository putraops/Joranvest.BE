  ...
  var pageFunction = function () {
    ...
    var loadDatatables = function () {
      ...
      $dt = $dtBasic.DataTable({
        ...
        ajax: {
          url: $.helper.baseApiPath("/role/getDatatables"),
          type: "POST",
    ...
    var SaveOrUpdate = function (e) {
      ...
      if (isvalidate) {
        ...
        console.log(record);
        $.ajax({
          url: $.helper.baseApiPath("/role/save"),
          type: 'POST',
          data: record,
          success: function (r) {
            console.log(r);
            if (r.status) {
              ...
              var $message = "Berhasil menambah Role";
              if (record.id != "") $message = "Berhasil mengubah Role";
