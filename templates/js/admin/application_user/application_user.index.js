  ...
  var pageFunction = function () {
    ...
    var loadDatatables = function () {
      ...
      $dt = $dtBasic.DataTable({
        ...
        ajax: {
          url: $.helper.baseApiPath("/application_user/getDatatables"),
          type: "POST",
          ...
          // },
          {
            ...
            render: function (data, type, row) {
              ...
              if (type === 'display') {
                ...
                html = `<span class="font-weight-bold" style="font-size: 10pt;">` + row.first_name + " " + row.last_name + `</span>`;
              }
              return html;
            }
          },
          ...
          },
          {
            ...
            render: function (data, type, row) {
              ...
              if (type === 'display') {
                ...
                if (row.is_admin) {
                  html = `<span class="font-weight-bold" style="font-size: 10pt;">` + _admin + `</span>`;
                }
              }
              return html;
            }
