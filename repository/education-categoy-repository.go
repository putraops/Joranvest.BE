...
type EducationCategoryRepository interface {
	...
	Lookup(request helper.ReactSelectRequest) []models.EducationCategory
	Insert(t models.EducationCategory) helper.Result
	Update(record models.EducationCategory) helper.Result
	GetById(recordId string) helper.Response
	DeleteById(recordId string) helper.Response

	OpenTransaction(trxHandle *gorm.DB) educationCategoryRepository
}
...
func NewEducationCategoryRepository(db *gorm.DB) EducationCategoryRepository {
...
func (r educationCategoryRepository) GetPagination(request commons.Pagination2ndRequest) interface{} {
	var response commons.PaginationResponse
	var records []entity_view_models.EntityEducationCategoryView
	var recordsUnfilter []entity_view_models.EntityEducationCategoryView
...
func (r educationCategoryRepository) GetAll(filter map[string]interface{}) []models.EducationCategory {
	var records []models.EducationCategory
	if len(filter) == 0 {
		r.DB.Find(&records)
...
func (r educationCategoryRepository) Lookup(request helper.ReactSelectRequest) []models.EducationCategory {
	records := []models.EducationCategory{}
	r.DB.Order("name asc")
...
func (r educationCategoryRepository) Insert(record models.EducationCategory) helper.Result {
...
func (r educationCategoryRepository) Update(record models.EducationCategory) helper.Result {
	var oldRecord models.EducationCategory
...
func (r educationCategoryRepository) GetById(recordId string) helper.Response {
	var record models.EducationCategory
...
func (r educationCategoryRepository) DeleteById(recordId string) helper.Response {
	var record models.EducationCategory
	r.DB.First(&record, "id = ?", recordId)
...
func (r educationCategoryRepository) OpenTransaction(trxHandle *gorm.DB) educationCategoryRepository {
	if trxHandle == nil {
