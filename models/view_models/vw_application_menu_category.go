...
type EntityApplicationMenuCategoryView struct {
	models.ApplicationMenuCategory
}

func (EntityApplicationMenuCategoryView) TableName() string {
	return "vw_application_menu_category"
}

func (EntityApplicationMenuCategoryView) ViewModel() string {
	...
	sql.WriteString("FROM application_menu_category r ")
	sql.WriteString("LEFT JOIN application_user u1 ON u1.id = r.created_by ")
	sql.WriteString("LEFT JOIN application_user u2 ON u2.id = r.updated_by ")
	return sql.String()
}
func (EntityApplicationMenuCategoryView) Migration() map[string]string {
	var view = EntityApplicationMenuCategoryView{}
