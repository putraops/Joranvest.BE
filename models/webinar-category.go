...
type WebinarCategory struct {
	...
	WebinarCategoryId string       `gorm:"type:varchar(50);" json:"webinar_category_id"`
	Description       string       `gorm:"type:text" json:"description"`

	WebinarCategory Emiten `gorm:"foreignkey:WebinarCategoryId;constraint:onUpdate:CASCADE,onDelete:CASCADE" json:"parent"`
}
