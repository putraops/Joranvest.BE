  ...
  var pageFunction = function () {
    ...
    var loadDatatables = function () {
      ...
      $dt = $dtBasic.DataTable({
        ...
        ajax: {
          url: $.helper.baseApiPath("/emiten_category/getDatatables"),
          type: "POST",
    ...
    var SaveOrUpdate = function (e) {
      ...
      if (isvalidate) {
        ...
        console.log(record);
        $.ajax({
          url: $.helper.baseApiPath("/emiten_category/save"),
          type: 'POST',
          data: record,
          success: function (r) {
            console.log(r);
    ...
    var getById = function (id) {
      $.ajax({
        url: $.helper.baseApiPath("/emiten_category/getById/" + id),
        type: 'GET',
        success: function (r) {
          if (r.status) {
    ...
    var deleteById = function (id, name) {
      Swal.fire({
        ...
        if (result.value) {
          $.ajax({
            url: $.helper.baseApiPath("/emiten_category/deleteById/" + id),
            type: 'DELETE',
            success: function (r) {
              console.log(r);
              if (r.status) {
