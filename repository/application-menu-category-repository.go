...
type ApplicationMenuCategoryRepository interface {
	Lookup(req map[string]interface{}) []models.ApplicationMenuCategory
	GetDatatables(request commons.DataTableRequest) commons.DataTableResponse
	GetAll(filter map[string]interface{}) []models.ApplicationMenuCategory
	GetTree() []commons.JStreeResponse
	Insert(t models.ApplicationMenuCategory) helper.Response
	Update(record models.ApplicationMenuCategory) helper.Response
	GetById(recordId string) helper.Response
	DeleteById(recordId string) helper.Response
}

type applicationMenuCategoryConnection struct {
	connection        *gorm.DB
...
func NewApplicationMenuCategoryRepository(db *gorm.DB) ApplicationMenuCategoryRepository {
	return &applicationMenuCategoryConnection{
		connection:        db,
		tableName:         models.ApplicationMenuCategory.TableName(models.ApplicationMenuCategory{}),
		viewQuery:         entity_view_models.EntityApplicationMenuCategoryView.ViewModel(entity_view_models.EntityApplicationMenuCategoryView{}),
		serviceRepository: NewServiceRepository(db),
	}
}

func (db *applicationMenuCategoryConnection) Lookup(req map[string]interface{}) []models.ApplicationMenuCategory {
	records := []models.ApplicationMenuCategory{}
...
func (db *applicationMenuCategoryConnection) GetDatatables(request commons.DataTableRequest) commons.DataTableResponse {
	var records []entity_view_models.EntityApplicationMenuCategoryView
	...
	if len(records) > 0 {
		...
		res.DataRow = []entity_view_models.EntityApplicationMenuCategoryView{}
	}
	return res
}

func (db *applicationMenuCategoryConnection) GetTree() []commons.JStreeResponse {
	var res []commons.JStreeResponse
	var records []models.ApplicationMenuCategory
	...
	if len(records) > 0 {
		for _, s := range records {
			...
			var childrenModel []models.ApplicationMenuCategory
...
func (db *applicationMenuCategoryConnection) GetAll(filter map[string]interface{}) []models.ApplicationMenuCategory {
	var records []models.ApplicationMenuCategory
	if len(filter) == 0 {
...
func (db *applicationMenuCategoryConnection) Update(record models.ApplicationMenuCategory) helper.Response {
	var oldRecord models.ApplicationMenuCategory
...
func (db *applicationMenuCategoryConnection) GetById(recordId string) helper.Response {
	var record entity_view_models.EntityApplicationMenuCategoryView
...
func (db *applicationMenuCategoryConnection) DeleteById(recordId string) helper.Response {
	var record models.ApplicationMenuCategory
	db.connection.First(&record, "id = ?", recordId)
