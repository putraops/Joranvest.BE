...
type roleMemberConnection struct {
	connection        *gorm.DB
...
func (db *roleMemberConnection) GetDatatables(request commons.DataTableRequest) commons.DataTableResponse {
	...
	if len(records) > 0 {
		...
		res.DataRow = []entity_view_models.EntityRoleMemberView{}
	}
	return res
}
...
func (db *roleMemberConnection) Insert(record models.RoleMember) helper.Response {
...
func (db *roleMemberConnection) Update(record models.RoleMember) helper.Response {
...
func (db *roleMemberConnection) GetById(recordId string) helper.Response {
...
func (db *roleMemberConnection) DeleteById(recordId string) helper.Response {
	var record models.RoleMember
