...
func NewTagRepository(db *gorm.DB) TagRepository {
	return &tagConnection{
		connection:        db,
		tableName:         models.Tag.TableName(models.Tag{}),
		viewQuery:         entity_view_models.EntityTagView.ViewModel(entity_view_models.EntityTagView{}),
		serviceRepository: NewServiceRepository(db),
	}
}

func (db *tagConnection) Lookup(req map[string]interface{}) []models.Tag {
	records := []models.Tag{}
...
func (db *tagConnection) GetDatatables(request commons.DataTableRequest) commons.DataTableResponse {
	...
	if len(records) > 0 {
		...
		res.DataRow = []entity_view_models.EntityTagView{}
	}
	return res
}
...
func (db *tagConnection) GetById(recordId string) helper.Response {
...
func (db *tagConnection) DeleteById(recordId string) helper.Response {
	var record models.Tag
