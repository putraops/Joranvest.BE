...
type technicalAnalysisConnection struct {
	connection        *gorm.DB
...
func NewTechnicalAnalysisRepository(db *gorm.DB) TechnicalAnalysisRepository {
	return &technicalAnalysisConnection{
		connection:        db,
		tableName:         models.TechnicalAnalysis.TableName(models.TechnicalAnalysis{}),
		viewQuery:         entity_view_models.EntityTechnicalAnalysisView.ViewModel(entity_view_models.EntityTechnicalAnalysisView{}),
		serviceRepository: NewServiceRepository(db),
	}
}

func (db *technicalAnalysisConnection) GetDatatables(request commons.DataTableRequest) commons.DataTableResponse {
...
func (db *technicalAnalysisConnection) GetAll(filter map[string]interface{}) []models.TechnicalAnalysis {
	var records []models.TechnicalAnalysis
	if len(filter) == 0 {
...
func (db *technicalAnalysisConnection) Insert(record models.TechnicalAnalysis) helper.Response {
...
func (db *technicalAnalysisConnection) Update(record models.TechnicalAnalysis) helper.Response {
	var oldRecord models.TechnicalAnalysis
...
func (db *technicalAnalysisConnection) GetById(recordId string) helper.Response {
	var record models.TechnicalAnalysis
...
func (db *technicalAnalysisConnection) DeleteById(recordId string) helper.Response {
	var record models.TechnicalAnalysis
